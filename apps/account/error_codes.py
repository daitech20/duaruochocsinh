...
class CustomerBulkUpdateErrorCode(models.TextChoices):
    BLANK = "blank"
    DUPLICATED_INPUT_ITEM = "duplicated_input_item"
    GRAPHQL_ERROR = "graphql_error"
    INVALID = "invalid"
...
class PermissionGroupErrorCode(models.TextChoices):
    REQUIRED = "required"
    UNIQUE = "unique"
...
class SendConfirmationEmailErrorCode(models.TextChoices):
    INVALID = "invalid"
